...
insert into lugar (codigo, nombre, tipo) values
  ...
  update lugar set tipo = 'Estado';


insert into lugar (codigo,fk_lugar,nombre) values
...
update lugar set codigo = codigo + 25 where tipo is NULL;
update lugar set tipo = 'Municipio' where tipo is NULL;
...
update lugar set tipo = 'Parroquia' where tipo is null;
update lugar set fk_lugar = fk_lugar + 25 where tipo= 'Parroquia';
